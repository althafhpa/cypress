// Script to remove somne URLS in urls.json. This is not part of test.
...
const filterUrlsById = (startId, endId) => {
    ...
    const sourceUrlsPath = path.join('cypress', 'fixtures', 'urls-full.json');
    const destUrlsPath = path.join('cypress', 'fixtures', 'urls.json');
