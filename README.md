...
**End to End Test Script**
   ...
   **Local Test:**
   ...
   3. Update cypress.env.json for envioronment variables BASELINE_URL and COMPARISON_URL with values for baseline and comparison URLs. This is required during results merge.
